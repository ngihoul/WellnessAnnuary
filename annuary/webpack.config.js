...
Encore
    ...
    .addEntry('providerPage', './assets/js/providerPage.js')
    .addEntry('internshipValidation', './assets/js/internshipValidation.js')
    .addEntry('promotionValidation', './assets/js/promotionValidation.js')
