...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, string $token = null): Response
    {
        ...
        if (null === $token) {
            throw $this->createNotFoundException('Aucun jeton d\'identification détecté dans l\'adresse utilisée.');
        }
        ...
        try {
            ...
            $this->addFlash('reset_password_error', sprintf(
                'Il y a eu un problème lors de la vérification - %s',
                $e->getReason()
            ));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Reinitialize unsuccessful attempts
