...
class Internship
{
    ...
    public function setDisplayFrom(\DateTimeInterface $displayFrom): self
    {
    ...
    public function getDisplayUntil(): ?\DateTimeInterface
    {
        return $this->displayUntil;
    }

    public function setDisplayUntil(\DateTimeInterface $displayUntil): self
    {
